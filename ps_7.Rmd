...
ggplot(aes(x = course_department, y = difference, color = difference)) +
  geom_point() +
  coord_flip() +
  labs(title = "Difference in Total Undergraduate \nEnrollment in Humanities Departments",
       subtitle = "Data 2018 and 2019 shows a decline in the majority \nof departments in Humanities",
  ...
  theme(plot.caption = element_text(color = "purple")) +
